	...
	private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver()
	{
		...
		public void onReceive(Context context, Intent intent)
		{
			...
			if (intent.getAction().equals(WifiManager.RSSI_CHANGED_ACTION))
			{
				...
				if (isWifiContected(BaseApplication.getInstance()) == WIFI_CONNECTED)
				{
					stopTimer();
					onNotifyWifiConnected();
					unRegister();
				} else if (isWifiContected(BaseApplication.getInstance()) == WIFI_CONNECT_FAILED)
				{
					stopTimer();
					closeWifi();
					onNotifyWifiConnectFailed();
					unRegister();
				} else if (isWifiContected(BaseApplication.getInstance()) == WIFI_CONNECTING)
				{
