...
public class SendAction
{
	...
	public static void doSend(OutputStream oStream, SendFileInfo sendFileInfo) throws IOException
	{
	...
	public static void writeFirstLine(Range range, OutputStream oStream) throws IOException
	{
		String cmd;
	...
	public static void writeFile2OStream(String uuid, String file, Range range, OutputStream oStream) throws IOException
	{
		RandomAccessFile accessFile = new RandomAccessFile(file, "r");
		accessFile.skipBytes(range.getBeginByte());
		final float realFileLength = range.getEndByte() - range.getBeginByte();
